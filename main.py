...
from EGolden_SWOA import EGolden_SWOA
import benchmark
import bound_X
import ideal_F
import dimension
...
for t in range(run_times):
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Sphere,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Rastrigin,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Ackley,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Griewank,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Rosenbrock,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Quartic,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Penalized1,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Penalized2,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Schwefel_226,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Step,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Kowalik,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = EGolden_SWOA(fitness=Shekel5,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Branin,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = EGolden_SWOA(fitness=Shekel7,
                             D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = EGolden_SWOA(fitness=benchmark.Shekel,
                             D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Hartmann6,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Zakharov,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.SumSquares,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Alpine,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Michalewicz,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Exponential,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Schaffer,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.BentCigar,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Elliptic,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.DropWave,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.CosineMixture,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = EGolden_SWOA(fitness=benchmark.LevyandMontalvo1,
